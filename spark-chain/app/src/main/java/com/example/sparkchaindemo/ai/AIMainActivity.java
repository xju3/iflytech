...
public class AIMainActivity extends AppCompatActivity implements View.OnClickListener {
	...
	private void initView() {
		...
		Button b1 = findViewById(R.id.ai_main_its);
		b1.setOnClickListener(this);
		b1.setVisibility(View.INVISIBLE);

		Button b2 = findViewById(R.id.ai_main_rtasr);
		b2.setOnClickListener(this);

		Button b3 = findViewById(R.id.ai_main_tts);
		b3.setOnClickListener(this);
		b3.setVisibility(View.INVISIBLE);
		Button b4 = findViewById(R.id.ai_main_asr);
		b4.setOnClickListener(this);

		b4.setVisibility(View.INVISIBLE);
		Button b5 = findViewById(R.id.ai_main_raasr);
